...
class NationalSecurity extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final questions = quiz.sentiment.natlSecQuestions;
        ...
        children: [
          ...
          ...positiveQuestions.map((question) => Container(
              ...
              child: Row(
                  ...
                  children: [
                    Icon(question.sentiment.nationalSecurity < 0 ? Icons.remove : Icons.add, color: Colors.white.withOpacity(0.33), size: 20,),
